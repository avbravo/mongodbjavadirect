 ...
 */
@RequestScoped
public class CorregimientoSupplierServices implements Serializable {
   // <editor-fold defaultstate="collapsed" desc="@Inject">

    @Inject
    CorregimientoRepository repository;

// </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="Optional<Corregimiento> findByPK(Document document, Referenced referenced)">
    /**
     *
     * @param document
...
// </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="List<Corregimiento> findAllByPK(Document document, Referenced referenced) ">
    /**
     *
     * @param document
     * @param referenced
     ...
     */
    public List<Corregimiento> findAllByPK(Document document, Referenced referenced) {
        ...
        try {
            ...
            if (documentPkList == null || documentPkList.isEmpty()) {
                ...
                for (Document documentPk : documentPkList) {
                    Optional<Corregimiento> optional = findByPK(documentPk, referenced);
                    if (optional.isPresent()) {
