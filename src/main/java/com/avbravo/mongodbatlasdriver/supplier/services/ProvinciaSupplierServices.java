 ...
 */
@RequestScoped
public class ProvinciaSupplierServices implements Serializable {
...
// </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="Optional<Provincia> findByPK(Document document, Referenced referenced)">
    /**
     *
     * @param document
     ...
     */
    public Optional<Provincia> findByPK(Document document,Referenced referenced) {
        try {
            ...
            if (referenced.typeFieldkeyString()) {
                ...
                //    provinciaOptional  = provinciaRepository.findById(Integer.parseInt(DocumentUtil.getIdValue(document, referenced)));
            }
...
// </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="List<Provincia> findAllByPK(Document document, Referenced referenced) ">
    /**
     *
     * @param document
     * @param referenced
     ...
     */
    public List<Provincia> findAllByPK(Document document, Referenced referenced) {
        ...
        try {
            ...
            if (documentPkList == null || documentPkList.isEmpty()) {
                ...
                for (Document documentPk : documentPkList) {
                    Optional<Provincia> optional = findByPK(documentPk, referenced);
                    if (optional.isPresent()) {
