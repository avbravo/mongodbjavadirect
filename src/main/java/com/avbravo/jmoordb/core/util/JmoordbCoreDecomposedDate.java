 ...
 * @author avbravo
 */
public class JmoordbCoreDecomposedDate {
/**
 ...
 */
    ...
    public JmoordbCoreDecomposedDate(Integer year, Integer day, Integer month, Integer hour, Integer minute, String nameOfMonth) {
        this.year = year;
        this.day = day;
        this.month = month;
        this.hour = hour;
